<template>
  <div>
    <el-container style="height: 600px; border: 1px solid #eee">
      ...
      <div class="toolBar">
        <div>
          <el-button icon="el-icon-upload" @click="dialogUploadVisible = true">导入数据</el-button>
          <el-button @click='handleShow'>数据建模</el-button>
...
<script>
  ...
  export default{
    ...
    methods:{
      ...
      handleExport(){
        console.log('method handleExport')
      },
      submitUpload(){
        console.log('method submitUpload')
